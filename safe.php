...
<section class="portfolio-item safe">

<div class="item-header" animation="grow-in" animation-delay=".5s">
	<div class="left">
		<div class="image-info">
			<img src="img/portfolio/safe.svg" />
			<!-- <a class="button" href="http://www.safecu.org">Check out the live site</a> -->
		</div>
	</div>
	<div class="right">
		<h2>Safe Credit Union</h2>
		<h3>A frontend build for one of the largest credit unions in California.</h3>
		<ul>
...
<div class="item-content sos" sos="true">
	<div class="container column centered">
		<img src="img/portfolio/safe-profile.png" />
		<a class="button" href="http://www.safecu.org">Check out the live site</a> 
	</div>
</div>
...
<div class="item-content sos" sos="true">
	<div class="container">
		<div class="col-sm-11 col-sm-offset-3">
			<h3 class="no-top-margin">Challenges</h3>
